...
from furpocalypse_registration.models import Attendee, Dealer, DealerAsst, Event
from furpocalypse_registration.tests.common import (
    DEFAULT_EVENT_ARGS,
    TEST_ATTENDEE_ARGS,
    TEST_DEALER_ARGS,
    TEST_DEALER_ASST_ARGS,
)
from furpocalypse_registration.views import ordering
