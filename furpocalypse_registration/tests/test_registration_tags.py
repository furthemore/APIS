...
from furpocalypse_registration.models import Event, Venue
from furpocalypse_registration.templatetags import registration_tags
from furpocalypse_registration.tests.common import DEFAULT_EVENT_ARGS
