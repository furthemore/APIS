...
urlpatterns = [
    ...
    re_path(r"^returning-staff/done/?$", registration.views.staff.staff_done, name="returning_staff_done"),
    re_path(r"^returning-staff/lookup/?$", registration.views.staff.find_returning_staff, name="find_returning_staff"),
    re_path(r"^returning-staff/info/?$", registration.views.staff.info_returning_staff, name="info_returning_staff"),
    re_path(r"^returning-staff/add/?$", registration.views.staff.add_returning_staff, name="add_returning_staff"),
    path('returning-staff/<slug:guid>/', registration.views.staff.returning_staff, name="returning_staff"),
    re_path(r"^new-staff/done/?$", registration.views.staff.staff_done, name="new_staff_done"),
    re_path(
        r"^new-staff/lookup/?$",
